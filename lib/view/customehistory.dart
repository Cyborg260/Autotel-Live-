...
class CustomeHistoryDateTimePicker extends StatefulWidget {
  ...
  const CustomeHistoryDateTimePicker(this.deviceID, this.screenRout,
      {super.key});
...
class _CustomeHistoryDateTimePickerState
    ...
    if (widget.screenRout == 'playroutonmap') {
      ...
      Navigator.pushNamed(
        ...
        arguments: DeviceHistoryOnMapIntialData(
            ...
            fromDate: dateFormat.format(initialDateTimeFrom),
            toDate: dateFormat
                .format(initialDateTimeTo.add(const Duration(days: 1))),
            fromTime: timeFormat.format(initialDateTimeFrom),
            toTime: timeFormat.format(initialDateTimeTo)),
      );
    }
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<DateTimePickerViewModel>(
      create: (BuildContext context) => dateTimePickerViewModel,
