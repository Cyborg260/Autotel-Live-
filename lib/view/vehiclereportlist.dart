...
class VehicleReportList extends StatefulWidget {
  const VehicleReportList({super.key});

  @override
  State<VehicleReportList> createState() => _VehicleReportListState();
}

class _VehicleReportListState extends State<VehicleReportList> {
        ...
        body: Column(
          children: [
            ...
            ChangeNotifierProvider<DeviceViewViewModel>(
              create: (BuildContext context) => deviceViewViewModelHistoryList,
